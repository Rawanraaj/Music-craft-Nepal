...
-- 1. Allow authenticated customers to upload return evidence into product-images bucket under returns/ path
...
-- 2. Allow public read access to images in product-images bucket
...
-- 3. Allow admins full access to product-images bucket
